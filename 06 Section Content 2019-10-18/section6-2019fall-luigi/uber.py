...
# If you're running luigi on the command line, the command is luigi --module uber CreateUberDrive --local-scheduler
# note you might need to use PYTHONPATH="." at the beginning (i.e. PYTHONPATH="." luigi --module uber ....)
